...
# Main script
def dora(input_dim=10, model_name="TinyLlama/TinyLlama-1.1B-Chat-v1.0", datasets: List[str] = ["wikitext", "wikitext-2", "wikitext-103"]):
    # model = torch.compile(SimpleModel(input_dim, output_dim))
